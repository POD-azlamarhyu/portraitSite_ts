...
var HobbysLeftCard = function (props) {
    return (react_1["default"].createElement("div", { className: "flex flex-col md:flex-row w-full h-94 bg-sky-300 mx-2 my-10 rounded-xl transform \n                            hover:scale-110 transition-transform" },
        ...
        react_1["default"].createElement("div", { className: "md:w-5/12 flex justify-center items-center align-middle" }, props.contents.image.src ? (react_1["default"].createElement("div", { className: "mx-3 my-3 xl:p-2" },
            react_1["default"].createElement("img", { src: props.contents.image.src, alt: "img" }))) : (react_1["default"].createElement("div", { className: "flex justify-center items-center m-1 p-2 h-64" },
