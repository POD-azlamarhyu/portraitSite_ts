...
var HobbysRightCard = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: "flex flex-col-reverse md:flex-row w-full h-94 bg-cyan-300 mx-2 my-10 rounded-xl transform \n                            hover:scale-110 transition-transform" },
        react_1["default"].createElement("div", { className: "md:w-5/12 flex justify-center items-center align-middle" }, contents.image.src ? (react_1["default"].createElement("div", { className: "mx-3 my-3 p-2" },
